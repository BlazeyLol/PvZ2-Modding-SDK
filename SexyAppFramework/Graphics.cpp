...
{
	mColor = Color::GetColorBlack();
}


void Sexy::GraphicsState::CopyStateFrom(const GraphicsState* theState)
{
...
const Sexy::Point* Sexy::Graphics::mPFPoints = nullptr;

Sexy::Graphics::Graphics(const Graphics& theGraphics)
{
	mColor = Color::GetColorBlack();
	mRenderContext = nullptr;
	InitContext(&theGraphics);
}

Sexy::Graphics::Graphics(Image* theDestImage)
{
	mRenderContext = nullptr;
	unkField = 0;
...
void Sexy::Graphics::InitContext(const Graphics* theOther)
{
	CallFunc<void, Graphics*, const Graphics*>(0x113739C, this, theOther);
}

void Sexy::Graphics::PushState()
{
...
//Sexy::Font* Sexy::Graphics::GetFont()
//{
//	return mFont;
//}
//
//void Sexy::Graphics::SetFont(Sexy::Font* theFont)
//{
//	mFont = theFont;
//}
//
//void Sexy::Graphics::SetColor(const Color& theColor)
//{
//	mColor = theColor;
//}
//
//const Color& Sexy::Graphics::GetColor()
//{
//	return mColor;
//}
//
//void Sexy::Graphics::SetDrawMode(int theDrawMode)
//{
//	mDrawMode = theDrawMode;
//}
//
//int Sexy::Graphics::GetDrawMode()
//{
//	return mDrawMode;
//}
//
//void Sexy::Graphics::SetColorizeImages(bool colorizeImages)
//{
//	mColorizeImages = colorizeImages;
//}
//
//bool Sexy::Graphics::GetColorizeImages()
//{
//	return mColorizeImages;
//}
//
//void Sexy::Graphics::SetFastStretch(bool fastStretch)
//{
//	mFastStretch = fastStretch;
//}
//
//bool Sexy::Graphics::GetFastStretch()
//{
//	return mFastStretch;
//}
//
//void Sexy::Graphics::SetLinearBlend(bool linear)
//{
//	mLinearBlend = linear;
//}
//
//bool Sexy::Graphics::GetLinearBlend()
//{
//	return mLinearBlend;
//}
//
//void Sexy::Graphics::FillRect(int theX, int theY, int theWidth, int theHeight)
//{
//	if (mColor.mAlpha == 0) {
//		return;
//	}
...
//	mRenderDevice->FillRect(aDestRect, mColor, mDrawMode);
//}
//
//void Sexy::Graphics::FillRect(const Rect& theRect)
//{
//	FillRect(theRect.mX, theRect.mY, theRect.mWidth, theRect.mHeight);
//}
//
//void Sexy::Graphics::DrawRect(int theX, int theY, int theWidth, int theHeight)
//{
//	if (mColor.mAlpha == 0) {
//		return;
//	}
...
//	{
//		mRenderDevice->SetRenderContext(mRenderContext);
//		mRenderDevice->DrawRect(aDestRect, mColor, mDrawMode);
//	}
//	else
//	{
...
//}
//
//void Sexy::Graphics::DrawRect(const Rect& theRect)
//{
//	DrawRect(theRect.mX, theRect.mY, theRect.mWidth, theRect.mHeight);
//}
//
//void Sexy::Graphics::ClearRect(int theX, int theY, int theWidth, int theHeight)
//{
//	mRenderDevice->SetRenderContext(mRenderContext);
//	Rect aDestRect = Rect(theX + mTransX, theY + mTransY, theWidth, theHeight).Intersection(mClipRect);
...
//}
//
//void Sexy::Graphics::ClearRect(const Rect& theRect)
//{
//	ClearRect(theRect.mX, theRect.mY, theRect.mWidth, theRect.mHeight);
//}
//
//void Sexy::Graphics::DrawString(const std::string& theString, int theX, int theY)
//{
//	if (mFont) {
...
//}
//
//void Sexy::Graphics::DrawLine(float theStartX, float theStartY, float theEndX, float theEndY)
//{
...
//
//	mRenderDevice->SetRenderContext(mRenderContext);
//	mRenderDevice->DrawLine(aStartX, aStartY, aEndX, aEndY, mColor, mDrawMode, false);
//}
//
//void Sexy::Graphics::DrawLineAA(float theStartX, float theStartY, float theEndX, float theEndY)
//{
//	double aStartX = theStartX + mTransX;
//	double aStartY = theStartY + mTransY;
//	double aEndX = theEndX + mTransX;
...
//
//	mRenderDevice->SetRenderContext(mRenderContext);
//	mRenderDevice->DrawLine(aStartX, aStartY, aEndX, aEndY, mColor, mDrawMode, true);
//}
//
//void Sexy::Graphics::PolyFill(const Point* theVertexList, int theNumVertices, bool convex)
//{
//	mRenderDevice->SetRenderContext(mRenderContext);
//	if (convex && mRenderDevice->CanFillPoly())
//	{
//		mRenderDevice->PolyFill3D(theVertexList, theNumVertices, &mClipRect, mColor, mDrawMode, mTransX, mTransY, convex);
//		return;
//	}
//
//
...
//	}
//
//	mRenderDevice->FillScanLines(aSpans, aSpanPos, mColor, mDrawMode);
//
//	delete ind;
//	delete mPFActiveEdgeList;
//}
//
//void Sexy::Graphics::DrawImage(Image* theImage, int theX, int theY)
//{
...
//		mRenderDevice->Blt(theImage, aDestRect.mX, aDestRect.mY, aSrcRect, mColorizeImages ? mColor : Color::White, mDrawMode);
//	}
//}
//
//void Sexy::Graphics::DrawImage(Image* theImage, int theX, int theY, const Rect& theSrcRect)
//{
...
//		mRenderDevice->SetRenderContext(mRenderContext);
//		mRenderDevice->StretchBlt(theImage, aDestRect, theSrcRect, mClipRect, mColorizeImages ? mColor : Color::White, mDrawMode, mFastStretch);
//		return;
//	}
//
...
//}
//
//void Sexy::Graphics::DrawImage(Image* theImage, const Rect& theDestRect, const Rect& theSrcRect)
//{
...
//}
//
//void Sexy::Graphics::DrawImage(Image* theImage, int theX, int theY, int theStretchedWidth, int theStretchedHeight)
//{
...
//
//	mRenderDevice->SetRenderContext(mRenderContext);
//	mRenderDevice->StretchBlt(theImage, aDestRect, aSrcRect, mClipRect, mColorizeImages ? mColor : Color::White, mDrawMode, mFastStretch);
//}
//
//void Sexy::Graphics::DrawImageF(Image* theImage, float theX, float theY)
//{
//	theX += mTransX;
//	theY += mTransY;
//
...
//	mRenderDevice->SetRenderContext(mRenderContext);
//	mRenderDevice->BltF(theImage, theX, theY, aSrcRect, mClipRect, mColorizeImages ? mColor : Color::White, mDrawMode);
//}
//
//void Sexy::Graphics::DrawImageF(Image* theImage, float theX, float theY, const Rect& theSrcRect)
//{
//	theX += mTransX;
//	theY += mTransY;
//
//	mRenderDevice->SetRenderContext(mRenderContext);
//	mRenderDevice->BltF(theImage, theX, theY, theSrcRect, mClipRect, mColorizeImages ? mColor : Color::White, mDrawMode);
//}
//
//void Sexy::Graphics::DrawImageMirror(Image* theImage, int theX, int theY, bool mirror)
//{
//	DrawImageMirror(theImage, theX, theY, Rect(0, 0, theImage->mWidth, theImage->mHeight), mirror);
//}
//
//void Sexy::Graphics::DrawImageMirror(Image* theImage, int theX, int theY, const Rect& theSrcRect, bool mirror)
//{
//	if (!mirror)
//	{
...
//	{
//		mRenderDevice->SetRenderContext(mRenderContext);
//		mRenderDevice->BltMirror(theImage, aDestRect.mX, aDestRect.mY, aSrcRect, mColorizeImages ? mColor : Color::White, mDrawMode);
//	}
//}
//
//void Sexy::Graphics::DrawImageMirror(Image* theImage, const Rect& theDestRect, const Rect& theSrcRect, bool mirror)
//{
//	if (!mirror)
//	{
...
//}
//
//void Sexy::Graphics::DrawImageRotated(Image* theImage, int theX, int theY, double theRot, const Rect* theSrcRect)
//{
...
//}
//
//void Sexy::Graphics::DrawImageRotated(Image* theImage, int theX, int theY, double theRot, int theRotCenterX, int theRotCenterY, const Rect* theSrcRect)
//{
//	DrawImageRotatedF(theImage, theX, theY, theRot, theRotCenterX, theRotCenterY, theSrcRect);
//}
//
//void Sexy::Graphics::DrawImageRotatedF(Image* theImage, float theX, float theY, double theRot, const Rect* theSrcRect)
//{
//	if (theSrcRect == nullptr)
//	{
...
//}
//
//void Sexy::Graphics::DrawImageRotatedF(Image* theImage, float theX, float theY, double theRot, float theRotCenterX, float theRotCenterY, const Rect* theSrcRect)
//{
//	theX += mTransX;
//	theY += mTransY;
//
...
//	{
//		Rect aSrcRect(0, 0, theImage->mWidth, theImage->mHeight);
//		mRenderDevice->BltRotated(theImage, theX, theY, aSrcRect, mClipRect, mColorizeImages ? mColor : Color::White, mDrawMode, theRot, theRotCenterX, theRotCenterY);
//	}
//	else
//	{
//		mRenderDevice->BltRotated(theImage, theX, theY, *theSrcRect, mClipRect, mColorizeImages ? mColor : Color::White, mDrawMode, theRot, theRotCenterX, theRotCenterY);
//	}
//}
//
//void Sexy::Graphics::DrawImageMatrix(Image* theImage, const SexyMatrix3& theMatrix, float x, float y)
//{
//	Rect aSrcRect(0, 0, theImage->mWidth, theImage->mHeight);
//	mRenderDevice->SetRenderContext(mRenderContext);
...
//}
//
//void Sexy::Graphics::DrawImageMatrix(Image* theImage, const SexyMatrix3& theMatrix, const Rect& theSrcRect, float x, float y)
//{
//	mRenderDevice->SetRenderContext(mRenderContext);
...
//}
//
//void Sexy::Graphics::DrawImageTransform(Image* theImage, const Transform& theTransform, float x, float y)
//{
//	DrawImageTransformHelper(theImage, theTransform, Rect(0, 0, theImage->mWidth, theImage->mHeight), x, y, false);
//}
//
//void Sexy::Graphics::DrawImageTransform(Image* theImage, const Transform& theTransform, const Rect& theSrcRect, float x, float y)
//{
//	DrawImageTransformHelper(theImage, theTransform, theSrcRect, x, y, false);
//}
//
//void Sexy::Graphics::DrawImageTransformF(Image* theImage, const Transform& theTransform, float x, float y)
//{
//	DrawImageTransformHelper(theImage, theTransform, Rect(0, 0, theImage->mWidth, theImage->mHeight), x, y, true);
//}
//
//void Sexy::Graphics::DrawImageTransformF(Image* theImage, const Transform& theTransform, const Rect& theSrcRect, float x, float y)
//{
//	DrawImageTransformHelper(theImage, theTransform, theSrcRect, x, y, true);
//}
//
//
//void Sexy::Graphics::DrawTriangleTex(Image* theTexture, const TriVertex& v1, const TriVertex& v2, const TriVertex& v3)
//{
//	TriVertex v[1][3] = { { v1, v2, v3 } };
//	mRenderDevice->SetRenderContext(mRenderContext);
//	mRenderDevice->BltTrianglesTex(theTexture, v, 1, mClipRect, mColorizeImages ? mColor : Color::White, mDrawMode, mTransX, mTransY, mLinearBlend);
//}
//
//void Sexy::Graphics::DrawTrianglesTex(Image* theTexture, const TriVertex theVertices[][3], int theNumTriangles)
//{
//	mRenderDevice->SetRenderContext(mRenderContext);
//	mRenderDevice->BltTrianglesTex(theTexture, theVertices, theNumTriangles, mClipRect, mColorizeImages ? mColor : Color::White, mDrawMode, mTransX, mTransY, mLinearBlend);
//}
//
//void Sexy::Graphics::DrawImageCel(Image* theImageStrip, int theX, int theY, int theCel)
//{
//	DrawImageCel(theImageStrip, theX, theY, theCel % theImageStrip->mNumCols, theCel / theImageStrip->mNumCols);
//}
//
//void Sexy::Graphics::DrawImageCel(Image* theImageStrip, const Rect& theDestRect, int theCel)
//{
//	DrawImageCel(theImageStrip, theDestRect, theCel % theImageStrip->mNumCols, theCel / theImageStrip->mNumCols);
//}
//
//void Sexy::Graphics::DrawImageAnim(Image* theImageAnim, int theX, int theY, int theTime)
//{
//	DrawImageCel(theImageAnim, theX, theY, theImageAnim->GetAnimCel(theTime));
//}
//
//void Sexy::Graphics::DrawImageCel(Image* theImageStrip, int theX, int theY, int theCelCol, int theCelRow)
//{
...
//}
//
//void Sexy::Graphics::DrawImageCel(Image* theImageStrip, const Rect& theDestRect, int theCelCol, int theCelRow)
//{
//	if (theCelRow < 0 || theCelCol < 0 || theCelRow >= theImageStrip->mNumRows || theCelCol >= theImageStrip->mNumCols)
//		return;
//
...
//}
//
//void Sexy::Graphics::ClearClipRect()
//{
//	mClipRect = Rect(0, 0, mDestImage->GetWidth(), mDestImage->GetHeight());
//}
//
//void Sexy::Graphics::SetClipRect(int theX, int theY, int theWidth, int theHeight)
//{
//	mClipRect = Rect(0, 0, mDestImage->GetWidth(), mDestImage->GetHeight()).Intersection(
//		Rect(theX + mTransX, theY + mTransY, theWidth, theHeight)
//	);
//}
//
//void Sexy::Graphics::SetClipRect(const Rect& theRect)
//{
//	SetClipRect(theRect.mX, theRect.mY, theRect.mWidth, theRect.mHeight);
//}
//
//void Sexy::Graphics::ClipRect(int theX, int theY, int theWidth, int theHeight)
//{
//	mClipRect = mClipRect.Intersection(Rect(theX + mTransX, theY + mTransY, theWidth, theHeight));
//}
//
//void Sexy::Graphics::ClipRect(const Rect& theRect)
//{
//	ClipRect(theRect.mX, theRect.mY, theRect.mWidth, theRect.mHeight);
//}
//
//void Sexy::Graphics::Translate(int theTransX, int theTransY)
//{
//	mTransX += theTransX;
//	mTransY += theTransY;
//}
//
//void Sexy::Graphics::TranslateF(float theTransX, float theTransY)
//{
//	mTransX += theTransX;
//	mTransY += theTransY;
//}
//
//void Sexy::Graphics::SetScale(float theScaleX, float theScaleY, float theOrigX, float theOrigY)
//{
//	mScaleX = theScaleX;
//	mScaleY = theScaleY;
...
//}
//
//void Sexy::Graphics::DrawImageBox(const Rect& theDest, Image* theComponentImage)
//{
//	DrawImageBox(Rect(0, 0, theComponentImage->mWidth, theComponentImage->mHeight), theDest, theComponentImage);
//}
//
//void Sexy::Graphics::DrawImageBox(const Rect& theSrc, const Rect& theDest, Image* theComponentImage)
//{
...
//}
//
//int	Sexy::Graphics::WriteString(const std::string& theString, int theX, int theY, int theWidth, int theJustification, bool drawString, int theOffset, int theLength, int theOldColor)
//{
//	Font* aFont = GetFont();
//	if (theOldColor == -1) {
...
//}
//
//int	Sexy::Graphics::WriteWordWrapped(const Rect& theRect, const std::string& theLine, int theLineSpacing, int theJustification, int* theMaxWidth, int theMaxChars, int* theLastWidth)
//{
...
//				{
//					WriteWordWrappedHelper(theLine, theRect.mX + anIndentX, theRect.mY + aYOffset, theRect.mWidth,
//						theJustification, true, aLineStartPos, aSpacePos - aLineStartPos, anOrigColorInt, theMaxChars);
//
...
//
//				aWrittenWidth = WriteWordWrappedHelper(theLine, theRect.mX + anIndentX, theRect.mY + aYOffset, theRect.mWidth,
...
//	{
//		int aWrittenWidth = WriteWordWrappedHelper(theLine, theRect.mX + anIndentX, theRect.mY + aYOffset, theRect.mWidth,
...
//}
//
//int	Sexy::Graphics::DrawStringColor(const std::string& theLine, int theX, int theY, int theOldColor)
//{
//	return WriteString(theLine, theX, theY, -1, -1, true, 0, -1, theOldColor);
//}
//
//int	Sexy::Graphics::DrawStringWordWrapped(const std::string& theLine, int theX, int theY, int theWrapWidth, int theLineSpacing, int theJustification, int* theMaxWidth)
//{
...
//}
//
//int	Sexy::Graphics::GetWordWrappedHeight(int theWidth, const std::string& theLine, int theLineSpacing, int* theMaxWidth)
//{
//	Graphics aTestG(nullptr);
//	aTestG.SetFont(mFont);
//	int aHeight = aTestG.WriteWordWrapped(Rect(0, 0, theWidth, 0), theLine, theLineSpacing, -1, theMaxWidth);
//	CallFunc<void, Graphics*>(0x11377B8, &aTestG);
//
//	return aHeight;
//}
//
//bool Sexy::Graphics::Is3D() const
//{
//	return mIs3D;
//}
//
//
//int Sexy::Graphics::PFCompareInd(const void* u, const void* v)
//{
//	return mPFPoints[*((int*)u)].mY <= mPFPoints[*((int*)v)].mY ? -1 : 1;
//}
//
//int Sexy::Graphics::PFCompareActive(const void* u, const void* v)
//{
//	return ((Edge*)u)->mX <= ((Edge*)v)->mX ? -1 : 1;
//}
//
//
//void Sexy::Graphics::PFDelete(int i) // remove edge i from active list
//{
//	int j;
//
...
//}
//
//void Sexy::Graphics::PFInsert(int i, int y) // append edge i to end of active list
//{
//	int j;
//	double dx;
//	const Point* p, * q;
...
//
//
//void Sexy::Graphics::DrawImageTransformHelper(Image* theImage, const Transform& theTransform, const Rect& theSrcRect, float x, float y, bool useFloat)
//{
//	if (theTransform.mComplex || mGraphics3D && useFloat)
//	{
...
//}
//
//bool Sexy::Graphics::DrawLineClipHelper(double* theStartX, double* theStartY, double* theEndX, double* theEndY)
//{
...
//}
//
//int Sexy::Graphics::WriteWordWrappedHelper(const std::string& theString, int theX, int theY, int theWidth, int theJustification, bool drawString, int theOffset, int theLength, int theOldColor, int theMaxChars)
//{
...
//	}
//
//	return WriteString(theString, theX, theY, theWidth, theJustification, drawString, theOffset, theLength, theOldColor);
//}